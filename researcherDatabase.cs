...
namespace KIT206_A2 //used to be KIT206_Week9
{
    abstract class researcherDatabase
    {
        ...
        public static List<Researcher> LoadAll() //add new one for publication, also that filter function, wherever that is
        {
        ...
        public static List<Publication> LoadPublications(int id)
        {
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    work.Add(new Publication //NEED TO UPDATE VARIABLE NAMES (cautiously think is done)
                    {
